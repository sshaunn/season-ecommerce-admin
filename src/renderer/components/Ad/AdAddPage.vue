...
<div class="content-page">
    <div class="content-nav">
        <el-breadcrumb class="breadcrumb" separator="/">
            <el-breadcrumb-item :to="{ name: 'ad' }">轮播图设置</el-breadcrumb-item>
            <el-breadcrumb-item>{{infoForm.id ? '编辑轮播图' : '添加轮播图'}}</el-breadcrumb-item>
        </el-breadcrumb>
    ...
    <div class="content-main">
        <div class="form-table-box">
            <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
                <el-form-item label="图片" prop="image_url" v-if="!infoForm.image_url">
                    <!--<img v-if="infoForm.image_url" :src="infoForm.image_url" class="image-show">-->
                    <el-upload name="image" class="upload-demo" :action="imgUrl" :headers="uploaderHeader" list-type="picture-card" :limit=1 :on-success="handleUploadSuccess">
                        <el-button size="small" type="primary">点击上传</el-button>
                    </el-upload>
                    <div class="form-tip">图片尺寸：690*297</div>
                </el-form-item>

                <el-form-item label="商品图片" prop="image_url" v-if="infoForm.image_url" class="image-uploader-diy new-height">
                    <img v-if="infoForm.image_url" :src="infoForm.image_url" class="image-show">
                    <el-button class="dele-list-pic" type="primary" @click="adRemove">
                    ...
                    <el-popover placement="right" v-model="related_pop">
                        <el-table :data="chooseRelateGoods" stripe style="width: 100%">
                            ...
                            <el-table-column label="操作">
                                <template scope="scope">
                                    <el-button size="small" type="danger" @click="relateSelect(scope.row.id)">选择
                                    </el-button>
                                </template>
                            </el-table-column>
                        </el-table>
...
export default {
    ...
    methods: {
        ...
        relateGoodsClick() {
            this.axios.post('ad/getallrelate', {
                id: this.infoForm.id
            }).then((response) => {
        ...
        handleUploadSuccess(res) {
            this.infoForm.image_url = api.url + res.data;
            /*this.axios.post('/fileUpload/upload', {url:this.infoForm.list_pic_url}).then((response) => {
        ...
        /*handleUpload(file){
          ...
          this.axios.post('http://52.62.171.204:8360/api/fileUpload/upload', formData, {
            headers: { 'Content-Type': 'multipart/form-data' }
          })
              .then( res => {
                console.log('step 2: res ',res);
                this.infoForm.image_url = api.url + res.data.data;
              })
        },*/
        /*getQiniuToken() {
            let that = this
        ...
        handleUploadImageSuccess(res, file) {
            this.infoForm.image_url = api.url + res.key;
        },
        getInfo() {
