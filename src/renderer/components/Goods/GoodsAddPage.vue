            ...
            <div class="form-table-box">
                <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
                    ...
                    <el-form-item label="商品轮播图" prop="goods_sn">
                        <div v-if="!infoForm.id" class="gallery_alert">
                            请保存后，在编辑页面上传轮播图
                        </div>

                        <div v-if=infoForm.id>
                            <el-upload
                                name="image"
                                class="upload-demo"
                                :action="imgUrl"
                    ...
                    <el-form-item label="型号和价格">
                        ...
                        <div class="spec-wrap">
                            <el-table :data="specData" stripe style="width: 100%">
                                ...
                                <el-table-column prop="goods_aka" label="简称" width="160">
                                    <template scope="scope">
                                ...
                                <el-table-column prop="cost" label="成本(澳元)" width="100">
                                    <template scope="scope">
                                        <el-input size="mini" v-model="scope.row.cost" placeholder="成本"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="retail_price" label="零售(澳元)" width="100">
                                    <template scope="scope">
...
export default {
    ...
    methods: {
        ...
        handleUpload(file) {
            ...
            this.axios.post(api.url + 'admin/upload/upload', formData, {
                headers: {'Content-Type': 'multipart/form-data'}
            })
                .then(res => {
                    console.log('step 2: res ', res);
                    this.infoForm.list_pic_url = api.url + res.data.data;
                    console.log('step 3: res', this.infoForm)
                })
        },
        galleryBefore() {
...
//                            this.specData = [];
        ...
        handleUploadListSuccess(res) {
            this.infoForm.list_pic_url = api.url + res.data;
        },
        ...
        handleUploadGallerySuccess(res) {
            console.log(res);
            console.log("gallery", this.gallery_list);
            if (res.data != '') {
                let urlData = api.url + res.data;
                let id = this.infoForm.id;
                let info = {
                    url: urlData,
                    goods_id: id
    ...
    mounted() {
        this.imgUrl = api.url + 'admin/upload/upload';
